...
class Installer
{
    ...
    //     if (!is_writable(base_path('resources/_lang'))) {
    //         $requirements[] = 'resources/_lang directory directory needs to be writable!';
    //     }
    ...
    //         'APP_DEBUG'     =>  'false',
    //         'APP_URL'     =>  url('/'),
    //         'APP_TIMEZONE'     =>  get_option('timezone'),
    //         'API_KEY'   =>  str_replace('$', '', str_replace('/', '', \Hash::make(url('/')))),
